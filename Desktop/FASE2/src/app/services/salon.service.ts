...
const DEFAULT_SALONS: Salon[] = [
  ...
  { id: 's3', name: 'Salón VIP', tables: 8, chairsAvailable: 80, tableclothsAvailable: 8, price: 800 }
];
...
export class SalonService {
  ...
  /**
   * Restaura los salones a su estado inicial
   */
  resetSalons(): void {
    this.salonsSignal.set(DEFAULT_SALONS.slice());
    this.save();
  }
}
